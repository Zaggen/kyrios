...
declare module 'lodash' {
  ...
  declare class Lodash {
    ...
    reduce<T: {}, U>(
      ...
      iteratee?: (
        accumulator: U,
        value: $NonMaybeType<$Values<$Exact<$ReadOnly<T>>>>,
        key: $Keys<$ReadOnly<T>>,
        object: T,
      ) => U,
      accumulator?: U,
    ...
    memoize<F: any => any>(func: F, resolver?: (...args: any[]) => any): F;
    ...
    isArray: ((any[]) => true) & (any => false);
    isArrayBuffer(value: any): boolean;
    isArrayLike(value: any): boolean;
    isArrayLikeObject(value: any): boolean;
    isBoolean: (boolean => true) & (any => false);
    ...
    isObject: ((value: Object) => true) & ((value: any) => false);
    isObject(value: {}): true;
    ...
    mapValues<R>(object?: ?Object, iteratee?: OIteratee<*>): R;
    ...
    camelCase<R: string>(string?: ?string): R;
...
declare module 'lodash/fp' {
  ...
  declare class Lodash {
    ...
    find<T>(
      ...
      collection: Array<T> | $ReadOnlyArray<T> | { [id: any]: T },
    ) => T | void;
    find<T>(
      predicate: Predicate<T> | OPredicate<T>,
      collection: Array<T> | { [id: any]: T },
