...
declare module 'styled-components' {
  declare export type Interpolation =
    | (<P: any>(executionContext: P) => string)
    | CSSRules
    | KeyFrames
    | string
    | number
  ...
  declare export type StyledElementType<T> = any
  ...
  declare export default StyledComponentList & {|
    [[call]]: (<P: {}, C: React$ComponentType<P>>(
      C,
    ) => StyledComponentType<C>) &
      (<P: {}, C: StyledComponentType<any>>(C) => StyledComponentType<C>),
  |}
}
